...
public class App {
    public App(Registry registry) {
        ...
        registry.registerPostTitleUpdater("Post", "setTitleCheckIsAuthor"); //: 발행된 블로그 글의 제목을 바꾸는 메서드를 등록한다.
        registry.registerPostBodyUpdater("Post", "setBodyCheckIsAuthor"); //: 발행된 블로그 글의 본문을 바꾸는 메서드를 등록한다.
