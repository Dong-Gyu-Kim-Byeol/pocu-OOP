...
public class App {
    public App(Registry registry) {
        ...
        registry.registerAuthorFilterSetter("Blog", "setAuthorIdFilterOrNull"); //: 작성자 필터를 설정하는 메서드를 등록한다.
        ...
        registry.registerCommentUpdater("PostComment", "updateBodyCheckIsAuthor"); //: 댓글의 내용을 바꾸는 메서드를 등록한다.
        registry.registerSubcommentUpdater("PostComment", "updateBodyCheckIsAuthor"); //: 하위 댓글의 내용을 바꾸는 메서드를 등록한다.
