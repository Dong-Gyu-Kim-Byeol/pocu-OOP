...
public class App {
    public App(Registry registry) {
        ...
        registry.registerPostTitleUpdater("User", "setPostTitle"); //: 발행된 블로그 글의 제목을 바꾸는 메서드를 등록한다.
        registry.registerPostBodyUpdater("User", "setPostBody"); //: 발행된 블로그 글의 본문을 바꾸는 메서드를 등록한다.

        registry.registerCommentUpdater("User", "setCommentBody"); //: 댓글의 내용을 바꾸는 메서드를 등록한다.
        registry.registerSubcommentUpdater("User", "setCommentBody"); //: 하위 댓글의 내용을 바꾸는 메서드를 등록한다.
