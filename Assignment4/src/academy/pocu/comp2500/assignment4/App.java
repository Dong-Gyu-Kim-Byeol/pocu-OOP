...
public class App {
    public App(Registry registry) {
        ...
        final String DrawPixelCommand = "DrawPixelCommand";
        final String IncreasePixelCommand = "IncreasePixelCommand";
        final String DecreasePixelCommand = "DecreasePixelCommand";
        final String ToUpperCommand = "ToUpperCommand";
        final String ToLowerCommand = "ToLowerCommand";
        final String FillHorizontalLineCommand = "FillHorizontalLineCommand";
        final String FillVerticalLineCommand = "FillVerticalLineCommand";
        final String ClearCommand = "FillVerticalLineCommand";
